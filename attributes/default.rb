...
default['graphite']['apache']['mod_wsgi']['enabled'] = false
default['graphite']['apache']['mod_wsgi']['procs'] = 5
default['graphite']['apache']['mod_wsgi']['threads'] = 5
default['graphite']['apache']['mod_wsgi']['script'] = File.join(node.graphite.base_dir, "conf/graphite.wsgi")
default['graphite']['apache']['vhost']['cookbook'] = nil
default['graphite']['apache']['vhost']['source'] = "graphite-vhost.conf.erb"
